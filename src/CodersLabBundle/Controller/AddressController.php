...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('CodersLabBundle:Address')->findAll();

        return $this->render('CodersLabBundle:address:index.html.twig', array(
            'addresses' => $addresses,
        ));
    }
    ...
    {
        $address = new Address();
        $form = $this->createForm('CodersLabBundle\Form\AddressType', $address);
        ...
        return $this->render('CodersLabBundle:address:new.html.twig', array(
            'address' => $address,
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('CodersLabBundle\Form\AddressType', $address);
        ...
        return $this->render('CodersLabBundle:address:edit.html.twig', array(
            'address' => $address,
