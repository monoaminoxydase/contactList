...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emails = $em->getRepository('CodersLabBundle:Email')->findAll();

        return $this->render('CodersLabBundle:email:index.html.twig', array(
            'emails' => $emails,
        ));
    }
    ...
    {
        $email = new Email();
        $form = $this->createForm('CodersLabBundle\Form\EmailType', $email);
        ...
        return $this->render('CodersLabBundle:email:new.html.twig', array(
            'email' => $email,
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('CodersLabBundle\Form\EmailType', $email);
        ...
        return $this->render('CodersLabBundle:email:edit.html.twig', array(
            'email' => $email,
